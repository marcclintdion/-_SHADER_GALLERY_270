...
//      "        column0               =  vec3(mvMatrix[0].xyz);//the_reflection_example_uses_the_mvpMatrix                             \n"   
//      "        column1               =  vec3(mvMatrix[1].xyz);                                                                        \n"   
//      "        column2               =  vec3(mvMatrix[2].xyz);                                                                        \n"     
...
//      "         mat3 n                =  mat3(column0, column1, column2);                                                             \n"         
        ...
        "         NdotL1                =  dot(normal, lightPosition_PASS.xyz);                                                         \n"                       
                  //----------------------------------------------------------------------
        "         wsR                   =  refract(normalize(wsI), normal, shininess);                                                  \n" 
        "         color                 =  textureCube(EnvMap, wsR);                                                                    \n"  
     
        "         gl_FragColor          =  mix(highp vec4(1.0, 1.0, 1.0, 1.0), color, attenuation) * NdotL1 * NdotL1;                         \n"                       
