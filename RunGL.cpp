...
void ProcessKeyboard(void)
{
    ...
    if (keys['L'])                                                                                                                      
    {	                                                                                                                                  
             shinyPlasticFireBall_SECOND_SPECULAR[0]         +=  0.01;        
    }                                                                                                                                   
    if (keys['J'])                                                                                                                   
    {                                                                                                                                   
             shinyPlasticFireBall_SECOND_SPECULAR[0]         -=  0.01;      
    ...
    if (keys['I'])                                                                                                                      
    {	                                                                                                                                  
             shinyPlasticFireBall_SECOND_SPECULAR[1]         +=  0.01;             
    }	                                                                                                                                  
    if (keys['K'])                                                                                                                      
    {	                                                                                                                                  
             shinyPlasticFireBall_SECOND_SPECULAR[1]         -=  0.01;         
    ...
    if (keys['O'])                                                                                                                      
    {	                                                                                                                                  
             shinyPlasticFireBall_SECOND_SPECULAR[2]         +=  0.01;           
    }	                                                                                                                                  
    if (keys['U'])                                                                                                                      
    {	                                                                                                                                  
             shinyPlasticFireBall_SECOND_SPECULAR[2]         -=  0.01;      
    ...
    if (keys['M'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_ATTENUATION                  +=  0.01;                                                                            
    }	                                                                                                                                  
    if (keys['N'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_ATTENUATION                  -=  0.01;              
    ...
    if (keys['X'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_SHININESS                           +=  0.01;               
    }	                                                                                                                                  
    if (keys['Z'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_SHININESS                           -=  0.01;           
    ...
    if (keys['V'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_adjustment                         +=  .001;                                                                            
    }	                                                                                                                                  
    if (keys['C'])                                                                                                                      
    {	                                                                                                                                  
             chromatic_dispersion_adjustment                         -=  .001;                                                                            
...
*/    //-----------------------------------------------------------------------------    
   //==============================================================================
       ...
       if(keys[VK_F8])
       {
             ...
             outSettings << "var         shinyPlasticFireBall_SECOND_SPECULAR[]    =  {"   << shinyPlasticFireBall_SECOND_SPECULAR[0] << ", "
                                                                                           << shinyPlasticFireBall_SECOND_SPECULAR[1] << ", "
                                                                                           << shinyPlasticFireBall_SECOND_SPECULAR[2] << ", 1.0};\n\n";            
             ...
             outSettings << "          moveSet[0]    =  "       << moveSet[0] << ";\n";
             outSettings << "          moveSet[1]    =  "       << moveSet[1] << ";\n";
             outSettings << "          moveSet[2]    =  "       << moveSet[2] << ";\n";               
             //------------------------------------------------------------------------------------------------------------------------------      
